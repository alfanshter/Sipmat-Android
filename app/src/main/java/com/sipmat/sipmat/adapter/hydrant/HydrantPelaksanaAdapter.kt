...
class HydrantPelaksanaAdapter(
    private val notesList: MutableList<ScheduleHydrantPelaksanaModel>,
    private val context: Context,

    ) : RecyclerView.Adapter<HydrantPelaksanaAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_hydrant_pelaksana, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.kode.text = "Kode : ${note.hydrant!!.kode}"
        holder.lokasi.text = "Lokasi : ${note.hydrant!!.lokasi}"
        if (note.isStatus ==0){
