...
import com.sipmat.sipmat.databinding.ActivityQrCodeCekKebisinganBinding
...
class QrCodeCekKebisinganActivity : AppCompatActivity(), AnkoLogger {
    ...
    lateinit var binding : ActivityQrCodeCekKebisinganBinding

    var api = ApiClient.instance()
    lateinit var progressDialog: ProgressDialog
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this,R.layout.activity_qr_code_cek_kebisingan)
